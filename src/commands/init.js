...
/**
 * /we:init - 프로젝트 초기화 명령어
 *
 * 서버에 DB/Redis 생성, .env 파일 생성, MCP 레지스트리 등록
 */
...
export const initCommand = new Command('init')
  ...
  .action(async (name, options) => {
    ...
    try {
      ...
      console.log(chalk.cyan(`\n🚀 Initializing project: ${config.projectName}\n`));
      ...
      console.log(chalk.white('\n📄 Files Created:'));
      console.log(chalk.cyan(`   • .env.local (local development)`));
      console.log(chalk.cyan(`   • /etc/containers/systemd/${config.projectName}.env (server)`));
      ...
      if (options.dryRun) {
        console.log(chalk.yellow('⚠️  DRY RUN - No changes were made\n'));
      }
